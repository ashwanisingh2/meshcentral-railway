<!DOCTYPE html><html lang="cs" dir="ltr" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <script>
        ...
        var agentsStr = ["Neznámé", "Windows 32bit konzole", "Windows 64bit konzole", "Windows 32bit služba", "Windows 64bit služba", "Linux 32bit", "Linux 64bit", "MIPS", "XENx86", "Android", "Linux ARM", "macOS x86-32bit", "Android x86", "PogoPlug ARM", "Android", "Linux Poky x86-32bit", "macOS x86-64bit", "ChromeOS", "Linux Poky x86-64bit", "Linux NoKVM x86-32bit", "Linux NoKVM x86-64bit", "Windows MinCore konzole", "Windows MinCore služba", "NodeJS", "ARM-Linaro", "ARMv6l / ARMv7l", "ARMv8 64bit", "ARMv6l / ARMv7l / NoKVM", "MIPS24KC (OpenWRT)", "Apple Silicon", "FreeBSD x86-64", "Neznámé", "Linux ARM 64 bit", "Alpine Linux x86 64 Bit (MUSL)", "Asistent (Windows)", "Armada370 - ARM32/HF (libc/2.26)", "OpenWRT x86-64", "OpenBSD x86-64", "Neznámé", "Neznámé", "MIPSEL24KC (OpenWRT)", "ARMADA/CORTEX-A53/MUSL (OpenWRT)", "Windows ARM 64bit console", "Windows ARM 64bit service", "ARMVIRT32 (OpenWRT)", "RISC-V x86-64"];
        ...
        */
        ...
        function updateDeviceDetails(node, hardware, network) {
           ...
           if (node.users && node.users.length > 0) {
            ...
            // Windows Idle Time
            if (node.idletime && node.idletime != -1) { x += addDetailItem("Doba nečinnosti", printTimer(node.idletime)); }
            ...
            if (hardware.identifiers) {
                ...
                if (x != '') { sections.push({ name: "Systém", html: x, img: 'system' }); }
            }

                            ...
                            <div id=loginpanel style="background-color:#979797;border-radius:16px;width:260px;padding:16px;text-align:center;clear:both;display:none">
                                <form method=post>
                                    ...
                                    <div id="authStrategies" style="display:none">
                                        ...
                                        <a id="auth-oidc" href="auth-oidc" title="Sign-in using OpenID Connect" style="display:none"><img src="{{oidcButtonIcon}}" srcset="{{oidcButtonIcon2x}}" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:white" /></a>
                                        <a id="auth-oidc-azure" href="auth-oidc" title="Sign-in with Azure using OpenID Connect" style="display:none"><img src="{{oidcButtonIcon}}" srcset="{{oidcButtonIcon2x}}" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:white" /></a>
                                        <a id="auth-oidc-google" href="auth-oidc" title="Sign-in with Google using OpenID Connect" style="display:none"><img src="{{oidcButtonIcon}}" srcset="{{oidcButtonIcon2x}}" width="32" height="32" style="margin-left:3px;margin-right:3px;border-radius:3px;box-shadow:2px 2px 5px black;cursor:pointer;background-color:white" /></a>
    ...
    <script>
        ...
        function startup() {
            ...
            if (authStrategies != '') {
                ...
                // Override OIDC button title if custom text is configured by admin
                var oidcButtonText = '{{{oidcButtonText}}}';
                if (oidcButtonText != '') {
                    Q('auth-oidc').title = oidcButtonText;
                    Q('auth-oidc-azure').title = oidcButtonText;
                    Q('auth-oidc-google').title = oidcButtonText;
                }
            }

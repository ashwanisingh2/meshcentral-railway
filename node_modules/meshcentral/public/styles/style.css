...
/* Modern Icons Customization Modal Styles */
.icon-customization-modal .modal-content {
    border: none;
    border-radius: var(--bs-border-radius-lg);
    box-shadow: 0 1rem 3rem rgba(0, 0, 0, 0.175);
}

.icon-customization-modal .modal-header {
    background: linear-gradient(135deg, var(--bs-primary) 0%, var(--bs-purple) 100%);
    border: none;
    border-radius: var(--bs-border-radius-lg) var(--bs-border-radius-lg) 0 0;
}

.icon-customization-modal .modal-title {
    font-weight: 600;
    color: white;
}

.icon-customization-modal .modal-body {
    padding: 1.5rem;
    background: var(--bs-gray-50);
}

/* Ensure close button is visible in all themes */
...
/* App night mode: force white close icon for icon customization modal */
body.night .icon-customization-modal .btn-close,
[data-bs-theme="dark"] .icon-customization-modal .btn-close {
    filter: none;
    opacity: 1;
    background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 16' fill='none' stroke='white' stroke-linecap='round' stroke-width='2'%3e%3cpath d='M2 2l12 12M14 2L2 14'/%3e%3c/svg%3e");
}

body.night .icon-customization-modal .btn-close:hover,
[data-bs-theme="dark"] .icon-customization-modal .btn-close:hover {
    opacity: 0.85;
}
